...
public class FragmentBank extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new FirebaseRecyclerAdapter<BankingModel, ViewHolderService>(options) {
            @Override
            protected void onBindViewHolder(@NonNull ViewHolderService holder, int position, @NonNull BankingModel model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Intent banking=new Intent(getActivity(), BankDetails.class);
                        banking.putExtra("bankId",adapter.getRef(position).getKey()); //send hotel Id to new activity
