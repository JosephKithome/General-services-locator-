 ...
 */
public class FragmentVeterinaryServices extends Fragment {
    ...
    public FragmentVeterinaryServices(int color) {
        this.color = color;
    }

    public FragmentVeterinaryServices() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new FirebaseRecyclerAdapter<VeterinaryModel, ViewHolderService>(options) {
            @Override
            protected void onBindViewHolder(@NonNull ViewHolderService holder, int position, @NonNull VeterinaryModel model) {

                holder.post_name.setText(model.getVetName());
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Intent aiport=new Intent(getActivity(), VeterinaryDetail.class);
                        aiport.putExtra("vetId",adapter.getRef(position).getKey()); //send hotel Id to new activity
