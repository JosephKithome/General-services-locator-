 ...
 */
public class FragmentPicnics extends Fragment {
    ...
    public FragmentPicnics(int color) {
        this.color = color;
    }

    public FragmentPicnics() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Query query = FirebaseDatabase.getInstance()
                .getReference().child("Picnic_sites");
        ...
        adapter = new FirebaseRecyclerAdapter<PicnicModel, ViewHolderService>(options) {
            @Override
            protected void onBindViewHolder(@NonNull ViewHolderService holder, int position, @NonNull PicnicModel model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Intent aiport=new Intent(getActivity(), PicnicDetails.class);
                        aiport.putExtra("picnicId",adapter.getRef(position).getKey()); //send hotel Id to new activity
