...
public class FragmentAirport extends Fragment {
    ...
    public FragmentAirport(int color) {
        this.color = color;
    }
    public FragmentAirport() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new FirebaseRecyclerAdapter<AirportModel, ViewHolderService>(options) {
            @Override
            protected void onBindViewHolder(@NonNull ViewHolderService holder, int position, @NonNull AirportModel model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Intent aiport=new Intent(getActivity(), Airportdetails.class);
                        aiport.putExtra("airportId",adapter.getRef(position).getKey()); //send Id to new activity
